# SecretNET.SNIP20 / Secret Token
**SecretNET.SNIP20** is a layer on top of the [**SecretNET client**](https://github.com/0xxCodemonkey/SecretNET) (for the Secret Network Blockchain) which supports all methods of the reference implementation of the SNIP20 contract:
